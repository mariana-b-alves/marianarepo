...
const ProductDetail = () => {
  ...
  useEffect(() => {
    document.body.style.overflow = showTransactionForm ? 'hidden' : 'unset';
    return () => {
      document.body.style.overflow = 'unset';
    };
  }, [showTransactionForm]);

  if (!product) return <p>Produto não existe.</p>;
  ...
  return (
    <div>
      ...
      <section className={`overlay ${menuOpen ? 'active' : ''}`} onClick={() => setMenuOpen(false)} />
